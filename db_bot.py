...
questions = [
    "Which players are on teams that play in a stadium with capacity over 50000?",
    "Which teams have coaches older than 50?",
    "List all players and the teams they belong to.",
    "Which stadiums host more than one team?",
    "Who are the coaches of teams that have more than 20 players?"
]
